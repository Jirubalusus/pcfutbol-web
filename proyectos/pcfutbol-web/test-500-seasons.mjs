...
console.log('🔥 TEST DE ESTRÉS - 500 TEMPORADAS');
...
for (let season = 1; season <= 500; season++) {
  ...
  // Progress
  if (season % 50 === 0) {
    console.log(`  Temporada ${season}/500 completada...`);
  }
}

const elapsed = ((Date.now() - startTime) / 1000).toFixed(2);

console.log(`\n⏱️ Tiempo: ${elapsed}s (${(500/parseFloat(elapsed)).toFixed(1)} temporadas/seg)`);
...
console.log('\n✅ Test de 500 temporadas completado');
