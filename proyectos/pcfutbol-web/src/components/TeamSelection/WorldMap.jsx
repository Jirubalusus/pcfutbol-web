...
const COUNTRY_DATA = {
  ...
  norway: { lat: 62.0, lng: 10.0, name: 'Noruega', code: 'NO', color: '#EF2B2D', continent: 'europe' },
  sweden: { lat: 62.0, lng: 15.0, name: 'Suecia', code: 'SE', color: '#006AA7', continent: 'europe' },
  poland: { lat: 51.9, lng: 19.1, name: 'Polonia', code: 'PL', color: '#DC143C', continent: 'europe' },
  russia: { lat: 55.8, lng: 37.6, name: 'Rusia', code: 'RU', color: '#0039A6', continent: 'europe' },
  ukraine: { lat: 48.4, lng: 31.2, name: 'Ucrania', code: 'UA', color: '#005BBB', continent: 'europe' },
  romania: { lat: 45.9, lng: 25.0, name: 'Rumanía', code: 'RO', color: '#002B7F', continent: 'europe' },
  hungary: { lat: 47.2, lng: 19.5, name: 'Hungría', code: 'HU', color: '#477050', continent: 'europe' },
